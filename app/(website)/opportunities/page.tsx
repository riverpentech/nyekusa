...
import { getOpportunities } from "@/repositories/opportunityRepository";
...
function EmptyState(props: EmptyStateProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-base font-medium text-foreground mb-1">
                No results for{" "}
                <span className="text-foreground font-semibold">"{props.query}"</span>
            </p>
            <p className="text-sm text-muted-foreground max-w-xs mb-5">
                Try different keywords, or{" "}
                {props.hasCategory ? "clear the category filter or " : ""}
                browse all listings.
            </p>
...
export default function Opportunities() {
    ...
    const emptyStateReason = useMemo((): EmptyStateProps | null => {
        ...
        return { reason: "empty-db" }; // fallback
    ...
    if (loading) {
        return (
            <div>
                <PageHero badge="Opportunities" title="Discover Opportunities" description="Internships, scholarships, competitions, and more — curated for NYEKUSA members." />
