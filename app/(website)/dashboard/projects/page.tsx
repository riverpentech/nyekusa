        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-slate-500 mt-1">
                    Explore innovative projects built by NYEKUSA members, showcasing creativity and technical excellence.
                </p>
            </div>
                        ...
                        >
                            ...
                            <div className="p-5">
                                <div className="flex flex-wrap items-center gap-2 mb-2">
                                    <span className={`text-xs font-medium px-2.5 py-0.5 rounded-full capitalize ${categoryStyles[project.category] || categoryStyles.other}`}>
